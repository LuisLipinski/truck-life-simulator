...
| Moeda | USD | definida pelo país-sede |
...
- moeda, salário, custo de vida, retenções e taxas definidos pelo país-sede da carreira.

O país-sede é escolhido antes da cidade-base. Ele não muda quando o motorista cruza uma fronteira: uma carreira sediada na Alemanha continua com folha alemã durante viagens pelo restante da Europa.

### Países disponíveis

| País-sede | Moeda | Salário mensal Nível 1 | Cidade-base | Retenções estimadas |
| --- | --- | ---: | --- | --- |
...
CSV, XLS e XLSX continuam compatíveis com versões anteriores. O formato v8 acrescenta:

- `countryCode`, nome do país e moeda da carreira;
...
| --- | --- |
| `src/App.jsx` | rotas, carreiras, criação e seleção do país-sede |
...
| `src/lib/csv.js` | backup v8, migração, validação e planilhas |
