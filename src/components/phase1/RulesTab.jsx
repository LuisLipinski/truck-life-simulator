  ...
  return (
    <>
      ...
      <section className="rules-grid compact-rules">
        ...
        <article className="panel rule-card"><span className="eyebrow">Reserva financeira</span><h2 className="line-label-with-tip">Reserva de emergência <Tip text="A reserva é patrimônio do motorista, separado do saldo disponível. Você pode fazer aportes manuais ou automatizá-los no fechamento do holerite." /></h2><p>O aporte pode ser feito manualmente em Saldo e Despesas ou configurado no Holerite para acontecer a cada fechamento semanal. A reserva rende 3,25% ao ano na simulação, proporcionalmente por semana. Ao resgatar, o valor volta ao saldo disponível e o motivo fica registrado no Histórico.</p></article>
